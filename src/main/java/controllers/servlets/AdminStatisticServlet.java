...
public class AdminStatisticServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        List<String> onlineUsers = adminStatisticService.getOnlineUsers();
        List<String> usersStat = adminStatisticService.getUserStatistic();
    ...
    private void printStat(List<String> stat, PrintWriter writer){
        for (var s : stat) {
